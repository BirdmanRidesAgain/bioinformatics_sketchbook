...
readr::write_csv(mean_loglikes, file = stringr::str_c(output_prefix,"_maxK", num_K,".csv"))
...
mean_ln_deltaK_plot <- mean_ln_only + delta_K_only +
  plot_annotation(title = stringr::str_c(output_prefix, " Evanno et al. plots"),
                  subtitle = stringr::str_c("K1 through K", num_K),
